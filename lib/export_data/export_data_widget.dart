...
class _ExportDataWidgetState extends State<ExportDataWidget> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<List<VotingDataRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<VotingDataRecord> exportDataVotingDataRecordList = snapshot.data!;
            ...
            body: SafeArea(
              ...
              child: Column(
                ...
                children: [
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(70.0, 40.0, 70.0, 0.0),
                    child: FFButtonWidget(
                      onPressed: () async {
                        await actions.downloadCollectionAsCSV(
                          exportDataVotingDataRecordList.toList(),
                        );
                      },
                      text: 'Download Voting Data',
